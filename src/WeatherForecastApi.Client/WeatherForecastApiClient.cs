...
namespace WeatherForecastApi.Client
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.1.2.0 (NJsonSchema v10.0.24.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial class WeatherForecastV1Client : IWeatherForecastV1Client
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public WeatherForecastV1Client(System.Net.Http.HttpClient httpClient)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ != "200" && status_ != "204")
                        {
                            ...
                            throw new WeatherForecastApiException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", (int)response_.StatusCode, responseData_, headers_, null);
                        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.1.2.0 (NJsonSchema v10.0.24.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial interface IWeatherForecastV2Client
    {
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        ...
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CreateAsync(CreateWeatherForecast weatherForecast);
        ...
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task EditAsync(System.Guid id, EditWeatherForecast weatherForecast);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task EditAsync(System.Guid id, EditWeatherForecast weatherForecast, System.Threading.CancellationToken cancellationToken);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.1.2.0 (NJsonSchema v10.0.24.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial class WeatherForecastV2Client : IWeatherForecastV2Client
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public WeatherForecastV2Client(System.Net.Http.HttpClient httpClient)
        {
            _httpClient = httpClient; 
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(() => 
            {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "401") 
                        {
                            ...
                            throw new WeatherForecastApiException<ProblemDetails>("A server side error occurred.", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        {
        ...
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task CreateAsync(CreateWeatherForecast weatherForecast)
        {
            return CreateAsync(weatherForecast, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task CreateAsync(CreateWeatherForecast weatherForecast, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2/weatherforecast");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(weatherForecast, _settings.Value));
        ...
        public async System.Threading.Tasks.Task<WeatherForecast> GetByIdAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2/weatherforecast/{id}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<WeatherForecast>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
        ...
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task EditAsync(System.Guid id, EditWeatherForecast weatherForecast)
        {
            return EditAsync(id, weatherForecast, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="WeatherForecastApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task EditAsync(System.Guid id, EditWeatherForecast weatherForecast, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.24.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class CreateWeatherForecast 
    {
        [Newtonsoft.Json.JsonProperty("date", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset Date { get; set; }
